...
/* admin/new.html.twig */
class __TwigTemplate_94a5dd8ce5b2e9c23f91c91c33f69b4821d2d67530a44e609a9ff13f6e04b162 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-6\">";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "imageFile", [], "any", false, false, false, 11), 'row');
        echo "</div>
        <div class=\"col-md-1\">";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "price", [], "any", false, false, false, 12), 'row');
        echo " </div>
    </div>
    ";
        // line 14
...
";
    ...
    {
        return array (  101 => 16,  96 => 14,  91 => 12,  87 => 11,  82 => 9,  77 => 7,  72 => 5,  68 => 3,  58 => 2,  35 => 1,);
    }
...
<div class=\"container mt-4\">
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-1\">{{ form_row(form.price) }} </div>
    </div>
    {{ form_widget(form) }}
    <button class=\"btn btn-success\">Créer</button>
    {{ form_end(form) }}
</div>
{% endblock%}", "admin/new.html.twig", "/Users/louisclement/T-WEB-600-LIL-6-1-ecommerce-louis1.clement/app/templates/admin/new.html.twig");
    }
}
