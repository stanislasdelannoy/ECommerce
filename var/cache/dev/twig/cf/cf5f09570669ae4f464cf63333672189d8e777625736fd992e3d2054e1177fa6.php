...
class __TwigTemplate_6c8fe86b789ae4cd93782d5c6864e9cdea0af279c21c3a19eb50c732b882f818 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 5
        if (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 5, $this->source); })()), "filename", [], "any", false, false, false, 5)) {
            // line 6
            echo "        <img src=\"/images/products/";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 6, $this->source); })()), "filename", [], "any", false, false, false, 6), "html", null, true);
            echo " \" alt=\"card image\" style=\"width: 100%; height: auto\">
    ";
        }
        // line 8
        echo "    <h1>";
...
";
    ...
    {
        return array (  108 => 14,  98 => 13,  85 => 9,  80 => 8,  74 => 6,  72 => 5,  69 => 4,  59 => 3,  36 => 1,);
    }
...
<div class=\"container mt-4\">
    {% if product.filename %}
        <img src=\"/images/products/{{ product.filename }} \" alt=\"card image\" style=\"width: 100%; height: auto\">
    {% endif %}
    <h1>{{ product.name }}</h1>
...
{% endblock %}", "product/show.html.twig", "/Users/louisclement/T-WEB-600-LIL-6-1-ecommerce-louis1.clement/app/templates/product/show.html.twig");
    }
}
